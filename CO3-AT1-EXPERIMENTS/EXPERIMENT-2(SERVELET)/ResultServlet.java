 ...
 *
 * NOTE: If this file lives inside a package in your Eclipse project
 * (e.g. package eglog;), add that as the very first line of the file.
 */
...
public class ResultServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<style>");
        out.println("body{font-family:Arial,sans-serif;background:linear-gradient(135deg,#667eea 0%,#764ba2 50%,#4facfe 100%);min-height:100vh;margin:0;padding:40px;display:flex;justify-content:center;align-items:center;}");
        out.println(".card{background:#fff;padding:30px 40px;border-radius:10px;box-shadow:0 10px 35px rgba(0,0,0,0.25);width:450px;}");
        ...
        out.println("a{display:inline-block;margin-top:15px;text-decoration:none;color:#764ba2;font-weight:600;}");
